...
class Game:
    ...
    def bullets(self, img):
        self.bullet_img = pg.image.load(os.path.join(img_folder,img)).convert_alpha()
    ...
    def load_data(self):
     ...
     #   self.bullet_img = pg.image.load(os.path.join(img_folder,'bullet.png')).convert_alpha()
        #self.bullet_img = pg.transform.scale(self.bullet_img,(TILESIZE,TILESIZE))
