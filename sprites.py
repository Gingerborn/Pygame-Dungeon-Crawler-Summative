    ...
    def update(self):
        ...
        if keys[pg.K_SPACE]:
            ...
            if now - self.last_shot > bullet_rate:
                ...
                if keys[pg.K_SPACE] and keys[pg.K_LEFT]:
                        self.rot = 180
                elif keys[pg.K_SPACE] and keys[pg.K_RIGHT]:
                        self.rot = 0
                elif keys[pg.K_SPACE] and keys[pg.K_UP]:
                        self.rot = 90
                elif keys[pg.K_SPACE] and keys[pg.K_DOWN]:
                        self.rot = 270   
